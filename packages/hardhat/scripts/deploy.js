...
const main = async () => {
  ...
  // const yourContract = await deploy("HonorBadge"); // <-- add in constructor args like line 19 vvvv

  const yourContract = await deploy("YourContract"); // <-- add in constructor args like line 19 vvvv

  // const yourContract = await deploy("LpToken"); // <-- add in constructor args like line 19 vvvv
